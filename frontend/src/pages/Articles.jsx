...
const Articles = () => {
  ...
  return (
    <div data-testid="articles-page">
      <PageHero image={IMG.bedugul} title="The Bali Travel Journal: Insider Guides & Curated Stories" desc="Handcrafted itineraries, cultural etiquette, hidden culinary spots, and expert advice from native Balinese locals to inspire mindful island exploration." eyebrow="Curated Local Insights">
