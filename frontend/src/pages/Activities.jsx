...
const Activities = () => {
  ...
  return (
    <div data-testid="activities-page">
      <PageHero image={IMG.bedugul} eyebrow="Authentic Island Adventures" eyebrowIcon={<Flame className="w-3.5 h-3.5" />} title="Thrilling Activities & Cultural Experiences" desc="Dive into the vibrant heart of Bali: adrenaline-fueled river rafting, sunrise volcano treks, sacred wellness rituals, and pristine marine encounters.">
