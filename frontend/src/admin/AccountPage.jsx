...
import { IdleSettingsCard } from './IdleSettingsCard';
...
export default function AccountPage() {
  ...
  return <div className="max-w-2xl space-y-10" data-testid="account-page"><div><p className="eyebrow" data-testid="account-eyebrow">KEAMANAN AKUN</p><h1 className="font-display text-3xl font-bold mt-2 text-ink" data-testid="account-title">Akun Admin</h1><p className="text-sm text-sand mt-3" data-testid="account-description">Ganti username dan password. Setelah disimpan, seluruh sesi lama akan keluar.</p>
