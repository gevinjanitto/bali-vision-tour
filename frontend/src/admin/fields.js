...
export const RESOURCE_CONFIG = {
  tours: {
    ...
    sections: [
      ...
      { title: 'Content', fields: [f('subtitle', 'Subtitle', 'text', { span: 2 }), f('description', 'Short description', 'textarea', { span: 2 }), f('longDescription', 'Long description', 'richtext', { span: 2 }), f('highlights', 'Highlights (one per line)', 'lines', { span: 2 }), f('inclusions', 'Inclusions (one per line)', 'lines'), f('exclusions', 'Exclusions (one per line)', 'lines')] },
  ...
  activities: {
    ...
    sections: [
      ...
      { title: 'Content', fields: [f('headline', 'Detail headline', 'text', { span: 2 }), f('description', 'Short description', 'textarea', { span: 2 }), f('longDescription', 'Long description', 'richtext', { span: 2 }), f('includes', 'Card includes (one per line)', 'lines'), f('tags', 'Detail tags (one per line)', 'lines'), f('inclusions', 'Inclusions (one per line)', 'lines'), f('exclusions', 'Exclusions (one per line)', 'lines')] },
  ...
  articles: {
    ...
    sections: [
      ...
      { title: 'Media & Author', fields: [f('image', 'Cover image', 'image', { span: 2 }), f('imageCaption', 'Image caption', 'text', { span: 2 }), f('author.name', 'Author name'), f('author.role', 'Author role'), f('author.avatar', 'Author avatar', 'image'), f('author.license', 'Author license / badge'), f('author.bio', 'Author bio', 'richtext', { span: 2 })] },
